...
export interface components {
    schemas: {
        ...
        QueryMyOrderResponse: {
            /** Format: int64 */
            id: number;
            options: components["schemas"]["ReadOnlyOrderOptionDto"][];
            /** @enum {string} */
            status: "PAYMENT_PENDING" | "CONFIRMATION_PENDING" | "DELIVERY_READY" | "DELIVERING" | "DELIVERY_COMPLETED" | "RETURN_PENDING" | "RETURNING" | "RETURNED" | "PAYMENT_FAIL" | "CONFIRMATION_CANCEL" | "PAYMENT_CANCEL" | "REFUND_RETURN_PENDING" | "REFUND_RETURNING" | "REFUND_RETURN_COMPLETED" | "REFUND_PENDING" | "REFUND_COMPLETED";
            memberInformation: components["schemas"]["ReadOnlyMemberInformation"];
            rentalPeriod: components["schemas"]["ReadOnlyRentalPeriod"];
            /** Format: int64 */
            totalPrice: number;
            deliveryInformation: components["schemas"]["ReadOnlyDeliveryInformation"];
            /** Format: int64 */
            productId: number;
        };
        QueryMyOrderResponses: {
            responses: components["schemas"]["QueryMyOrderResponse"][];
        };
        ReadOnlyDeliveryInformation: {
            deliveryAddress: string;
            deliveryDetailAddress: string;
            postalCode: string;
            recipientName: string;
        ...
        ReadOnlyMemberInformation: {
            /** Format: int64 */
            memberId: number;
            email: string;
            phone: string;
        };
        ReadOnlyOrderOptionChoiceDto: {
            /** Format: int64 */
            id: number;
            /** Format: int64 */
            productOptionChoiceId: number;
        };
        ReadOnlyOrderOptionDto: {
            /** Format: int64 */
            id: number;
            /** Format: int64 */
            productOptionId: number;
            orderOptionChoices: components["schemas"]["ReadOnlyOrderOptionChoiceDto"][];
        };
        ReadOnlyRentalPeriod: {
            /** Format: date-time */
            startDateTime: string;
            /** Format: date-time */
            endDateTime: string;
    ...
    query_2: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["QueryMyOrderResponses"];
                };
            };
        };
    };
